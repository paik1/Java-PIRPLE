...
public class TicTacToe extends javax.swing.JFrame {
    ...
    private void winningGame(){
        ...
        for(int i=1;i<9;i++){
            ...
            if(output.equalsIgnoreCase("XXX")){
                JOptionPane.showMessageDialog(this, "Player X has won the match", "Tic Tac Toe", JOptionPane.INFORMATION_MESSAGE);
                xCount++;
                gameScore();
            }
            else if(output.equalsIgnoreCase("OOO")){
                JOptionPane.showMessageDialog(this, "Player 0 has won the match", "Tic Tac Toe", JOptionPane.INFORMATION_MESSAGE);
                oCount++;
                gameScore();      
            }
            else if(gameCount == 9 && !(output.equalsIgnoreCase("OOO") && !(output.equalsIgnoreCase("XXX")))){
                JOptionPane.showMessageDialog(this, "Cats game!", "Tic Tac Toe", JOptionPane.INFORMATION_MESSAGE);
                break;
            }
        }
    }
